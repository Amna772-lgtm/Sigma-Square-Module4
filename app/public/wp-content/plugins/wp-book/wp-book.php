 ...
 * @wordpress-plugin
 * Plugin Name:       wp-book
 * Plugin URI:        https://http://module4.local/wp-admin/wp-book.php
 * Description:       A plugin to manage books with custom post type, taxonomies, meta boxes, and more.
 * Version:           1.0.0
 * Author:            Amna
 * Author URI:        https://https://Amna.example.com//
 * License:           GPL-2.0+
